...
-(void)setDataModel:(NewsListModel *)model{
    ...
    [qihaoString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:11] range:NSMakeRange(0, 7)];
    [qihaoString addAttribute:NSForegroundColorAttributeName value:GS_COLOR_DARKGRAY range:NSMakeRange(0, 7)];
    [qihaoString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:11] range:NSMakeRange(7, qihaoString.length - 7)];
    [qihaoString addAttribute:NSForegroundColorAttributeName value:GS_COLOR_LIGHTBLACK range:NSMakeRange(7, qihaoString.length - 7)];
    ...
    if ([model.has_lottery integerValue] == 1) {
        ...
        [wiinerString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:11] range:NSMakeRange(0, 8)];
        [wiinerString addAttribute:NSForegroundColorAttributeName value:GS_COLOR_DARKGRAY range:NSMakeRange(0, 8)];
        [wiinerString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:11] range:NSMakeRange(8, wiinerString.length - 8)];
        ...
        [joinCountString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:11] range:NSMakeRange(0, 5)];
        [joinCountString addAttribute:NSForegroundColorAttributeName value:GS_COLOR_DARKGRAY range:NSMakeRange(0, 5)];
        [joinCountString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:11] range:NSMakeRange(5,joinCountString.length - 5)];
        ...
        [luckyNumString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:11] range:NSMakeRange(0, 5)];
        [luckyNumString addAttribute:NSForegroundColorAttributeName value:GS_COLOR_DARKGRAY range:NSMakeRange(0, 5)];
        [luckyNumString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:11] range:NSMakeRange(5,luckyNumString.length - 5)];
        ...
        [openTimeString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:11] range:NSMakeRange(0, 5)];
        [openTimeString addAttribute:NSForegroundColorAttributeName value:GS_COLOR_DARKGRAY range:NSMakeRange(0, 5)];
        [openTimeString addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:11] range:NSMakeRange(5,openTimeString.length - 5)];
