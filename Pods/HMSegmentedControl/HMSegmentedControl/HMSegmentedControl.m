...
- (void)commonInit {
    ...
    self.selectedTextColor = [UIColor colorWithRed:225.0/225.0 green:42.0/255.0 blue:82.0/255.0 alpha:1];
    self.backgroundColor = [UIColor whiteColor];
    self.opaque = NO;
    self.selectionIndicatorColor = [UIColor colorWithRed:225.0/225.0 green:42.0/255.0 blue:82.0/255.0 alpha:1];
    ...
    self.selectionIndicatorBoxLayer.borderWidth = 10.0f;
    
    self.contentMode = UIViewContentModeRedraw;
    //    self.goBtn=[UIButton buttonWithType:UIButtonTypeCustom];
    //    [ self.goBtn addTarget:self action:@selector(goBtnClick) forControlEvents:UIControlEventTouchUpInside];
    //    self.goBtn.frame=CGRectMake(300,10, 20, 20);
    //    [self.goBtn setImage:[UIImage imageNamed:@"navmore"] forState:UIControlStateNormal];
...
-(void)goBtnClick{
    [self setSelectedSegmentIndex:self.sectionTitles.count-1];
